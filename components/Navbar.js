      ...
      <AnimatePresence>
        {isMobileMenuOpen && (
          <motion.div 
            ...
            className="lg:hidden fixed inset-0 bg-white flex flex-col items-center pt-20"
          >
            <ul className="space-y-6 text-lg font-semibold">
              <li><Link href="/" onClick={() => setIsMobileMenuOpen(false)}>Kezdőlap</Link></li>
              <li><Link href="/portfolio" onClick={() => setIsMobileMenuOpen(false)}>Portfólió</Link></li>
              <li><Link href="/contact" onClick={() => setIsMobileMenuOpen(false)}>Kapcsolat</Link></li>
              <li><Link href="/about" onClick={() => setIsMobileMenuOpen(false)}>Rólam</Link></li>
            </ul>
          </motion.div>
        )}
      </AnimatePresence>
