...
export const SERVICES_DATA = {
  ...
  "portre": {
    ...
    heroImage: "/images/_BF_0185_hero.jpg",
    ...
    gallery: [
      ...
      { src: "/images/_BF_0299.JPEG", alt: "Művészi esti portré a keszthelyi móló kivilágított korlátjánál" },
      { src: "/images/_BF_0300.JPEG", alt: "Hangulatos éjszakai fotó a Balaton-parton, sejtelmes fényekkel" },
      { src: "/images/_BF_0306.JPEG", alt: "Közeli portré fotó esti fényben a móló végénél" },
      ...
      { src: "/images/_BF_9914.JPEG", alt: "Tavaszi portré fotózás színes tulipánmező közepén" },
      { src: "/images/_BF_9914-2.JPEG", alt: "Művészi távlati kép a virágzó tulipánok között" },
      { src: "/images/_BF_0167.JPEG", alt: "Életkép a tulipánszüret idején készült tavaszi fotózásról" },
      { src: "/images/_BF_0167-2.JPEG", alt: "Vidám női portré a végtelen tulipánsorok között" },
      { src: "/images/_BF_0180.JPEG", alt: "Természetes fényekkel készült fotó a virágzó mezőn" },
      { src: "/images/_BF_7636.webp", alt: "Természetes fényekkel készült fotó a virágzó mezőn" },
      { src: "/images/_BF_0180-2.JPEG", alt: "Romantikus hangulatú közeli portré a tulipánok ölelésében" },
      { src: "/images/_BF_0185.JPEG", alt: "Napsütötte tavaszi portré a színes virágoskertben" },
      { src: "/images/_BF_7632.webp", alt: "Természetes fényekkel készült fotó a virágzó mezőn" },
      { src: "/images/_BF_0185-2.JPEG", alt: "Kreatív kompozíció a tulipánmezőn készült fotósorozatból" },
      { src: "/images/_BF_0190.JPEG", alt: "Profi kültéri portré a tavaszi virágzás idején" },
      { src: "/images/_BF_0195.JPEG", alt: "Érzelmes pillanat a tulipánok között, lágy tónusokkal" },
  ...
  "autok": {
    ...
    gallery: [
      ...
      { src: "/images/_BF_0573.JPG", alt: "Városi motoros kaland a 11. kerület új városközpontjában" },
      { src: "/images/_BF_0560.JPG", alt: "Brutális motorkerékpár a Kopaszi-gát minimalista hátterével" },
      { src: "/images/_BF_0547.JPG", alt: "Esti fények és króm: motoros fotózás a MOL székháznál" },
      { src: "/images/_BF_0535.JPG", alt: "Szabadság két keréken a Duna-parthoz közeli modern utcákon" },
      { src: "/images/_BF_0511.JPG", alt: "Művészi motoros életkép Budapest legújabb negyedéből" },
      { src: "/images/_BF_0488.JPG", alt: "Portré fotó a motorossal a Kopaszi-gát üvegépületei előtt" },
